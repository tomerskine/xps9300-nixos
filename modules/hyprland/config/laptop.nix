  ...
  home-manager.users.${username} = _: {
    home.file = {
      ...
      ".config/hypr/hyprland.conf".text = ''
                ...
                exec-once = waybar & swww-daemon & swww img ~/.config/backgrounds/porthole.jpg & mako & lxqt-policykit-agent & dbus-update-activation-environment --systemd WAYLAND_DISPLAY XDG_CURRENT_DESKTOP
